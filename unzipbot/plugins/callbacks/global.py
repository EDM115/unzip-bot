...
from unzipbot.utils.archive import (
    extr_files,
    get_files,
    make_keyboard,
    make_keyboard_empty,
...
from unzipbot.utils.thumbnail import silent_del
from unzipbot.utils.upload import answer_query, get_size, send_file, send_url_logs

_commands = import_module("unzipbot.plugins.commands.global")
get_stats = _commands.get_stats
https_url_regex = _commands.https_url_regex
sufficient_disk_space = _commands.sufficient_disk_space
