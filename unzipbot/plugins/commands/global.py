...
from unzipbot.db.functions import (
    add_banned_user,
    add_merge_task,
    add_user,
    check_user,
...
from unzipbot.utils.archive import get_files
from unzipbot.utils.thumbnail import add_thumb, del_thumb
...
@Client.on_message(filters=filters.command(commands="start"))
...
@Client.on_message(filters=filters.private & filters.command(commands="clean"))
...
@Client.on_message(filters=filters.command(commands="help"))
...
@Client.on_message(filters=filters.command(commands="about"))
...
@Client.on_message(filters=filters.command(commands="privacy"))
...
@Client.on_message(filters=filters.private & filters.command(commands="cancel"))
...
@Client.on_message(filters=filters.private & filters.command(commands="merge"))
...
@Client.on_message(filters=filters.private & filters.command(commands="done"))
...
@Client.on_message(filters=filters.private & filters.command(commands="mode"))
...
@Client.on_message(filters=filters.command(commands="stats"))
...
@Client.on_message(filters=filters.command(commands="broadcast") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="sendto") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="report"))
...
@Client.on_message(filters=filters.command(commands="ban") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="unban") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="info"))
...
@Client.on_message(filters=filters.command(commands="user") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="user2") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="self") & filters.user(Config.BOT_OWNER))
async def info_self(_, message: Message):
    self_infos = await unzipbot_client.get_me()
    await message.reply(text=f"`{self_infos}`")


@Client.on_message(filters=filters.command(commands="getthumbs") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="redbutton") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="maintenance") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.private & filters.command(commands="addthumb"))
async def thumb_add(_, message: Message):
    await add_thumb(_=unzipbot_client, message=message)


@Client.on_message(filters=filters.private & filters.command(commands="delthumb"))
async def thumb_del(_, message: Message):
    await del_thumb(message)


@Client.on_message(filters=filters.command(commands="cleanall") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="cleantasks") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="logs") & filters.user(Config.BOT_OWNER))
async def logz(_, message: Message):
    await send_logs(message.from_user.id)


@Client.on_message(filters=filters.command(commands="restart") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="gitpull") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="donate"))
...
@Client.on_message(filters=filters.command(commands="vip"))
...
@Client.on_message(filters=filters.command(commands="dbexport") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="commands"))
...
@Client.on_message(filters=filters.command(commands="admincmd") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="eval") & filters.user(Config.BOT_OWNER))
...
@Client.on_message(filters=filters.command(commands="exec") & filters.user(Config.BOT_OWNER))
